...
namespace Labb2___Bildtjanster_i_Azure_AI
{
    internal class PictureRecognition
    {
        ...
        static public async void ImageMenu(string imageFile)
        {
            ...
            Console.WriteLine("What do you want to receive? Enter own of the following options: " +
